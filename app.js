...
GUIDE_DATA.heroes = [
  {
    hero: "问剑",
    aliases: ["弈剑", "内剑"],
    role: "目前缺少合格 3.32 玩家专门来源；以下为地图技能推导，待玩家来源验证。",
    entries: [
      {
        title: "可验证前不要强写成定论",
        sourceIds: [],
        summary: "没有找到标题明确 3.32 且主角为问剑/内剑的玩家帖子或视频。页面只给出技能组合逻辑，不把旧版内剑攻略冒充 3.32 攻略。",
        sections: [
          {
            title: "候选玩法",
            items: [
              "普攻剑痕流：剑痕 + 剑气诀/剑芒诀 + 孤闻剑法 + 孤星剑诀阵。理由是孤闻能让残影 100% 打出剑痕，孤星剑诀阵又能吃孤闻的攻击次数加成。",
              "内元技能流：混元剑渡 + 剑气诀/剑芒诀 + 大雁初行/凝剑印 + 滴血心剑或天雷裂闪剑。理由是混元、心剑、天雷都吃内元或极元，适合堆内元与极元修为。",
            ],
          },
          {
            title: "装备方向",
            items: [
              "剑痕流优先剑类武器、物理攻击、筋骨、攻速、会心/提元，再补吸血和防御。",
              "内元流优先内元、极元修为、技能冷却与生存；不要只堆物攻。",
            ],
          },
          {
            title: "待补来源",
            items: ["需要 3.32 问剑完整单通、问剑加点帖子或玩家解说视频后再落定路线。"],
          },
        ],
      },
    ],
  },
  {
    ...
    entries: [
      {
        title: "3.32 法魂单 Boss 思路",
        sourceIds: ["bili-fahun-jll"],
        summary: "现有合格来源是法魂单挑鸠罗相技巧视频，能支撑 Boss 操作参考，但不足以证明完整单通路线。正文结合地图技能写成可执行方向。",
        sections: [
          {
            title: "技能组合",
            items: [
              "黑炎爆发：黑炎 + 法咒一式/二式 + 红雷之炎 + 萧声天凤舞或炎龙破天荒。黑炎、红雷、天凤舞都围绕内元与极元爆发，适合打 Boss 窗口。",
              "炎鸟普攻：炎鸟 + 法咒一式 + 六道之护 + 祝融悲歌。法咒一式减少炎鸟积聚次数，六道之护能提升自身普攻和炎鸟伤害，祝融悲歌提供攻速窗口。",
              "仙疗/生存：仙疗咒 + 法咒零式/二式 + 六道之护 + 炎龙破天荒。更偏多人和容错，单通需要输出装备补足。",
            ],
          },
          {
            title: "节奏与操作",
  ...
  },
  {
    ...
    entries: [
      {
        title: "破月骨灰单通与鸠罗相处理",
        sourceIds: ["bili-poyue-single", "bili-poyue-jll"],
        summary: "破月有完整骨灰单通和单挑鸠罗相两类 3.32 来源：长录像看发育，短视频看 Boss 爆发窗口。",
        sections: [
          {
            title: "技能组合",
            items: [
              "一刀爆发：殇亡一刀 + 刀解式 + 八荒狂野/血劫 + 红月三千破。刀解式提高殇亡命中，红月三千破在殇亡后一段时间内接上有命中收益。",
              "血刀续航：血刀 + 刀解式/刀逆式 + 血劫 + 月影千华。血劫路线能缓解月影反噬，适合持续输出。",
              "低血收益：血刀或殇亡一刀 + 血劫/碎月旋 + 恨缺殇亡。恨缺吃生命缺失收益，但需要极强吸血、防御和操作。",
            ],
          },
          {
            title: "节奏与操作",
    ...
    entries: [
      {
        title: "鱼湘单通与远程爆发",
        sourceIds: ["bili-yuxiang-single"],
        summary: "鱼香单通视频作者特别提醒套装穿戴顺序会影响伤害，说明这个英雄后期输出很吃装备细节。",
        sections: [
          {
            title: "技能组合",
            items: [
              "虹刃普攻：虹刃 + 会神/韧弦 + 候鹰 + 秘法箭矢或翼行九天。会神提高虹刃概率，候鹰提高会心，适合远程点杀。",
              "连坞穿透：百川无尽/蜀花香 + 荼化/会神 + 连坞 + 翼行九天或千鸟归魂。更偏清线、穿透和控制。",
              "召唤鹰辅助：虹刃/百川/蜀花香 + 对应二段 + 召唤鹰 + 秘法箭矢/千鸟归魂，适合利用鹰承接净化、消魔或额外输出。",
            ],
          },
          {
            title: "节奏与操作",
    ...
    entries: [
      {
        title: "斗佛多作者单通对照",
        sourceIds: ["bili-doufo-single-a", "bili-doufo-single-b", "bili-doufo-single-c"],
        summary: "斗佛有三份 3.32 玩家单通来源，可以横向看出它的共性：能抗、能控，但输出不能掉队。",
        sections: [
          {
            title: "技能组合",
            items: [
              "稳健控制：佛怒海 + 金刚经/达摩心经 + 莲华圣体 + 天龙八部赞。佛怒海和天龙八部赞提供控制，莲华圣体提供容错。",
              "拳劲输出：罗汉长拳 + 无量义经 + 大悲菩提 + 圣行。围绕攻速和拳劲爆发，适合装备较好时提速。",
              "掌印法系：太罗禅印 + 达摩心经 + 大悲菩提/莲华圣体 + 天龙吼。更看重范围、爆炸和内元收益。",
            ],
          },
          {
            title: "节奏与操作",
    ...
    entries: [
      {
        ...
        sourceIds: ["bili-yanbu-single-a", "bili-yanbu-single-b", "bili-yanzi-96"],
        summary: "燕捕有两份单通和一份高难 Boss 样本。单通看节奏，高难切片看终局输出窗口。",
        sections: [
          {
            title: "技能组合",
            items: [
              "燕翔普攻：燕翔 + 辅皇诀/神皇诀 + 空流燕 + 燕雨春分。燕翔负责普攻触发，空流燕给攻速和贴身窗口，燕雨春分补持续群伤。",
              "控制机动：燕去燕返 + 辅皇诀 + 归燕回旋/空流燕 + 夜燕啼鸣。更偏控场与保命，适合不熟悉 Boss 站位时。",
              "爆发冲刺：燕回旋/燕翔 + 神皇诀 + 归燕回旋 + 万燕怒蓝关。需要熟悉距离，冲刺越远收益越明显。",
            ],
          },
          {
            title: "节奏与操作",
  ...
  },
  {
    ...
    entries: [
      {
        title: "青麈单人通关提炼",
        sourceIds: ["bili-qingzhu-explain", "bili-qingzhu-single-song", "bili-qingzhu-normal"],
        summary: "青麈资料质量最好：一份带思路讲解的 3.32 单人通关，加两份不同作者单通，可用于总结发育和技能方向。",
        sections: [
          {
            title: "技能组合",
            items: [
              "黑洞 AOE：悲天神击 + 绝路心诀/灭天心诀 + 灭天邪印 + 天罡幽绝阵。灭天邪印能让天罡幽绝阵产生黑洞效果，适合清怪和控场。",
              "悔无单体：悔无 + 灭天心诀/贯日心诀 + 遁之击 + 天灭式。风月难存。偏攻速和单体输出，要求装备更好。",
              "远程穿透：悔元归一 + 贯日心诀 + 悲极归元 + 天罡幽绝阵。射程和穿透更舒服，适合稳扎稳打。",
            ],
          },
          {
            title: "发育节奏",
  ...
  },
  {
    hero: "天音",
    aliases: ["执刑仙"],
    role: "暂缺合格 3.32 玩家专门来源；以下只做地图技能推导。",
    entries: [
      {
        title: "待玩家来源验证的技能方向",
        sourceIds: [],
        summary: "没有找到标题明确 3.32 且主角为天音/执刑仙的玩家攻略。旧版本技能测试不再作为参考。",
        sections: [
          {
            title: "候选玩法",
            items: [
              "地雷流：地结印 + 聚/破 + 疾行之道 + 皇律禁断或往圣天牢。疾行之道能自动布地结印，适合提前布场和引怪。",
              "判律控制：判律之刃 + 聚/破 + 止禁之刀/天降印 + 皇律禁断。偏范围控制和持续轰炸。",
              "天罚普攻：天罚刀式 + 疾 + 疾行之道 + 判生断死。八斩风。适合身法差与高爆发，但来源待验证。",
            ],
          },
          {
            title: "装备方向",
          ...
          {
            title: "待补来源",
            items: ["需要 3.32 天音单通、执刑仙加点或玩家文字帖后再写成正式攻略。"],
          },
        ],
      },
    ],
        ...
        sections: [
          {
            title: "技能组合",
            items: [
              "道麟召唤：召唤道麟 + 玄妙心法/玄极心法 + 掠影/乾坤一剑 + 太初雷引法阵或十方剑阵。玄妙给道麟分裂，掠影能加强道麟额外伤害。",
              "净灵符控制：太虚净灵符 + 玄妙心法 + 血心爆 + 魔行圣踪/太初雷引法阵。重点是减速、聚怪和法术爆发。",
              "剑法续航：玄真剑法 + 魔炼之元 + 乾坤一剑/掠影 + 十方剑阵。偏本体输出和回血。",
            ],
          },
          {
            title: "节奏与操作",
        ...
        sections: [
          {
            title: "技能组合",
            items: [
              "身法普攻：小葵神剑 + 小葵定律/小葵法规 + 剑影同途 + 绕花乱舞。小葵神剑吃身法，剑影同途给分身普攻，绕花乱舞适合单体 Boss。",
              "内元控制：混元剑渡 + 小葵原则/小葵法规 + 躲猫猫 + 彩龙裂空/尽散霞光。更偏控制、范围和保命。",
              "辅助圣印：小葵神剑/混元剑渡 + 对应二段 + 圣印加持 + 尽散霞光/彩龙裂空。多人局价值更高，单通要补输出。",
            ],
          },
          {
            title: "节奏与操作",
